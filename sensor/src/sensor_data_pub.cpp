...
class IMU_Pub : public rclcpp::Node
{
	public:
		IMU_Pub()
			: Node("IMU_Pub")
		{
			publisher_ = this->create_publisher<sensor_interfaces::msg::Imu>("IMU", 1000);
	...
	private:
		void timer_callback()
		{
			...
			{
				Packet_Flag1 = 0;
				auto message = sensor_interfaces::msg::Imu();
		...
		rclcpp::Publisher<sensor_interfaces::msg::Imu>::SharedPtr publisher_;
};
...
class GNSS_Pub : public rclcpp::Node
{
	public:
		GNSS_Pub()
			: Node("GNSS_Pub")
		{
			publisher_ = this->create_publisher<sensor_interfaces::msg::Gnss>("GNSS", 1000);
			timer_ = this->create_wall_timer(
	...
	private:
		...
		{	
			if(Packet_Flag2 == 1 && Packet_Flag3 == 1)
			{
				Packet_Flag2 = 0;
				Packet_Flag3 = 0;			
				auto message = sensor_interfaces::msg::Gnss();
		...
		rclcpp::TimerBase::SharedPtr timer_;
		rclcpp::Publisher<sensor_interfaces::msg::Gnss>::SharedPtr publisher_;
};

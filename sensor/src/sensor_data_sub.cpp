...
class SensorSubs : public rclcpp::Node
{
  public:
    ...
    : Node("SensorSubs")
    {
      subscription_imu = this->create_subscription<sensor_interfaces::msg::Imu>(
      "IMU", 1000, std::bind(&SensorSubs::topic_callback_imu, this, _1));
      
      subscription_gnss = this->create_subscription<sensor_interfaces::msg::Gnss>(
      "GNSS", 1000, std::bind(&SensorSubs::topic_callback_gnss, this, _1));
    }

  private:
    void topic_callback_imu(const sensor_interfaces::msg::Imu & msg) const
    {
    ...
    void topic_callback_gnss(const sensor_interfaces::msg::Gnss & msg) const
    {
    ...
    rclcpp::Subscription<sensor_interfaces::msg::Imu>::SharedPtr subscription_imu;
    rclcpp::Subscription<sensor_interfaces::msg::Gnss>::SharedPtr subscription_gnss;
};
